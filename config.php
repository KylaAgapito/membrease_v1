...
$dbname = "membrease_v5"; //NAME OF THE DATABASE! The name of **this** php project is membrease_v1!
...
// $username = "root"; // Adjust if needed
// $password = ""; // Adjust if needed
// $dbname = "membrease_v4"; //NAME OF THE DATABASE! The name of **this** php project is membrease_v1!
